...
// GET /api/data — returns ALL data in one response (consolidated URL)
...
// GET /api/data/export — legacy alias
...
// POST /api/data — imports projects, tasks, and items (consolidated URL)
...
// POST /api/data/import — legacy alias
