  ...
  return (
    <DialogPortal>
      ...
      <div
        ref={ref}
        className={cn(
          "fixed left-1/2 top-1/2 z-50 grid w-[calc(100%-2rem)] max-w-lg -translate-x-1/2 -translate-y-1/2 gap-4 border border-border bg-bg-elevated p-5 sm:p-6 shadow-lg rounded-lg animate-in fade-in-0 zoom-in-95",
          className
        )}
