import "../_runtime.mjs";
import { S as invariant, _ as isResolvedRedirect, b as isNotFound, g as isRedirect, h as executeRewriteInput, i as RouterProvider, m as resolveManifestAssetLink, t as renderRouterToStream, y as rootRouteId } from "../_libs/@tanstack/react-router+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DHiStLl6.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CdDtUgUs.mjs"),
		import("./start-Dtl0e55a.mjs"),
		import("../__23tanstack-start-plugin-adapters-UL1TkXz1.mjs")
	]);
	return {
		routerEntry,
		startEntry,
